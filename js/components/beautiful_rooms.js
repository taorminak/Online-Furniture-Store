...
const containerRoomsButtonNext = document.querySelector(
  ".container-rooms__button-next",
);
...
const containerRoomsPhotoImage = document.querySelectorAll(
  ".container-rooms__photo_image",
);
