(function (global, factory) {
  ...
  let constructRef = Reflect.construct;

  function _construct(Parent, args, Class) {
    if (_isNativeReflectConstruct()) {
      constructRef = Reflect.construct;
    } else {
      constructRef = function _construct(Parent, args, Class) {
        var a = [null];
        a.push.apply(a, args);
    ...
    return constructRef.apply(null, arguments);
  }
  ...
  function _wrapNativeSuper(Class) {
    ...
    const wrapperFunction = function (Class) {
  ...
  function onScroll() {
    ...
    if (Object.is(swiper.translate, -0)) swiper.translate = 0;
    swiper.updateActiveIndex();
    swiper.updateSlidesClasses();
    var newProgress;
    var translatesDiff = swiper.maxTranslate() - swiper.minTranslate();
...
let mySlider = new Swiper(".main__swiper-container", {
  navigation: {
